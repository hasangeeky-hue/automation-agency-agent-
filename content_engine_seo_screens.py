...
JS = ("<script>"
      ...
      "function ssBriefFill(a){uiNotWired('ssBriefFill')}"
      "function ssCmd(a){uiNotWired('ssCmd')}"
      "function ssCompetitors(a){uiNotWired('ssCompetitors')}"
      "function ssDomain(a){uiNotWired('ssDomain')}"
      "function ssDraft(a){uiNotWired('ssDraft')}"
      "function ssKeywords(a){uiNotWired('ssKeywords')}"
      "function ssPrompts(a){uiNotWired('ssPrompts')}"
      "function ssReport(a){uiNotWired('ssReport')}"
      "function ssRerun(a){uiNotWired('ssRerun')}"
      "function ssResearch(a){uiNotWired('ssResearch')}"
      "function ssSearch(a){uiNotWired('ssSearch')}"
      "function ssTrack(a){uiNotWired('ssTrack')}"
      "</script>")
