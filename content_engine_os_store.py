...
SCHEMA = {
    ...
    "audit_logs":     ([("actor", "text"), ("action", "text"),
                       ...
                       ["actor", "action", "at"]),
    # -- media buying ----------------------------------------------------
    "ad_accounts":    ([("provider", "text"), ("external_account_id", "text"),
                        ("name", "text"), ("currency", "text"),
                        ("timezone", "text"), ("status", "text"),
                        ("credentials_reference", "text")],
                       ["provider", "external_account_id"]),
    "media_campaigns": ([("name", "text"), ("provider", "text"),
                         ("ad_account_id", "text"), ("state", "text"),
                         ("provider_status", "text"), ("objective", "text"),
                         ("provider_objective", "text"),
                         ("external_campaign_id", "text"),
                         ("budget_type", "text"),
                         ("budget_amount", "double precision"),
                         ("currency", "text"), ("buying_type", "text"),
                         ("start_at", "text"), ("end_at", "text"),
                         ("attribution_model", "text"),
                         ("synced_at", "text"), ("state_at", "text")],
                        ["provider", "state", "external_campaign_id"]),
    "ad_groups":      ([("campaign_id", "text"), ("name", "text"),
                        ("audience_id", "text"), ("state", "text"),
                        ("budget_amount", "double precision"),
                        ("bid", "double precision"),
                        ("external_id", "text")],
                       ["campaign_id", "state"]),
    "ads":            ([("campaign_id", "text"), ("ad_group_id", "text"),
                        ("name", "text"), ("creative_id", "text"),
                        ("landing_page_url", "text"), ("state", "text"),
                        ("external_id", "text")],
                       ["campaign_id", "ad_group_id", "creative_id"]),
    "audiences":      ([("name", "text"), ("type", "text")], ["name", "type"]),
    "creatives":      ([("name", "text"), ("type", "text"),
                        ("asset_url", "text"), ("hook", "text"),
                        ("headline", "text"), ("cta", "text"),
                        ("concept", "text"), ("angle", "text"),
                        ("persona", "text"), ("funnel_stage", "text"),
                        ("version", "double precision")],
                       ["name", "concept", "angle"]),
    "creative_versions": ([("creative_id", "text"),
                           ("version", "double precision"),
                           ("published_at", "text")], ["creative_id"]),
    "media_plans":    ([("objective", "text"),
                        ("budget", "double precision"),
                        ("currency", "text"), ("period_start", "text"),
                        ("period_end", "text"),
                        ("target_cpa", "double precision"),
                        ("target_roas", "double precision"),
                        ("target_leads", "double precision"),
                        ("kpi", "text"), ("allocation", "jsonb"),
                        ("forecast", "jsonb"),
                        ("assumptions", "jsonb")], ["objective"]),
    "ad_metrics":     ([("day", "text"), ("provider", "text"),
                        ("campaign_id", "text"), ("ad_group_id", "text"),
                        ("ad_id", "text"),
                        # The dimensional breakdowns the spec names. Empty
                        # string means the platform row carried no dimension,
                        # which is the truth for an account-level pull.
                        ("country", "text"), ("device", "text"),
                        ("placement", "text"), ("age", "text"),
                        ("gender", "text"),
                        ("hour", "text"), ("creative_id", "text"),
                        ("objective", "text"), ("currency", "text"),
                        ...
                        ("video_25", "double precision"),
                        ("video_50", "double precision"),
                        ("video_75", "double precision"),
                        ("video_100", "double precision"),
                        ...
                        ("provider_reported_conversions", "double precision"),
                       ...
                       ["day", "campaign_id", "provider", "creative_id"]),
    # §4 RAW PROVIDER DATA IS NEVER DELETED. When a number disagrees with
    # the platform UI, the original response is the only way to settle it.
    "provider_raw_metrics": ([("platform", "text"), ("account_id", "text"),
                              ...
                              ("retrieved_at", "text"),
                              ("checksum", "text")],
                             ["platform", "report_date",
                              "provider_object_id"]),
    # §3 every sync job accounts for what it received, wrote and dropped
    "search_initiatives": ([("kind", "text"), ("target", "text"),
                            ("project", "text"), ("state", "text"),
                            ("state_at", "text"), ("risk", "text"),
                            ("agent", "text"), ("outcome", "text"),
                            ("implementation_result", "text"),
                            ("search_result", "text"),
                            ("business_result", "text"),
                            ("baseline_at", "text")],
                           ["state", "kind", "target", "outcome"]),
    "search_agent_runs": ([("agent", "text"), ("objective", "text"),
                           ("initiative_id", "text"), ("state", "text"),
                           ("started_at", "text")],
                          ["agent", "state", "initiative_id"]),
    "sync_jobs":      ([("ad_account_id", "text"), ("platform", "text"),
                        ("report_type", "text"), ("date_from", "text"),
                        ("date_to", "text"), ("started_at", "text"),
                        ("completed_at", "text"), ("status", "text"),
                        ("records_received", "double precision"),
                        ("records_written", "double precision"),
                        ("records_failed", "double precision"),
                        ("api_version", "text"),
                        ("provider_request_id", "text"),
                        ("error", "text"),
                        ("freshness_timestamp", "text")],
                       ["platform", "status", "report_type"]),
    "ad_rollups":     ([("grain", "text"), ("bucket", "text"),
                        ("campaign_id", "text"), ("provider", "text"),
                        ("impressions", "double precision"),
                        ("clicks", "double precision"),
                        ("spend", "double precision"),
                        ("conversions", "double precision"),
                        ("conversion_value", "double precision"),
                        ("computed_at", "text")],
                       ["grain", "bucket", "campaign_id"]),
    "publish_jobs":   ([("campaign_id", "text"), ("provider", "text"),
                        ("state", "text"), ("idempotency_key", "text"),
                        ("attempt", "double precision"),
                        ("finished_at", "text")],
                       ["campaign_id", "state"]),
    "creative_experiments": ([("name", "text"), ("hypothesis", "text"),
                              ("metric", "text"), ("status", "text"),
                              ("winner", "text"), ("started_at", "text"),
                              ("ended_at", "text")], ["status"]),
    "sync_runs":      ([("provider", "text"), ("started_at", "text"),
                        ("completed_at", "text"), ("status", "text"),
                        ("objects_synced", "double precision")],
                       ["provider", "started_at"]),
    "media_anomalies": ([("campaign_id", "text"), ("type", "text"),
                         ("severity", "text"), ("metric", "text"),
                         ("detected_at", "text"), ("status", "text")],
                        ["campaign_id", "severity", "status"]),
