# Screen contract: aeo_answer_detail

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
One question, and how well we answer it.

## USER QUESTIONS
What is missing from our answer?

## USER DECISIONS
Approve the improved answer.
...
## LOOP CONNECTION
Feeds an initiative with a success metric.
