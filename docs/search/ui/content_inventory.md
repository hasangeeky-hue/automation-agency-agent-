# Screen contract: content_inventory

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Every content page with its performance and health.

## USER QUESTIONS
What is growing, decaying or dead?

## USER DECISIONS
Which page to refresh, merge or retire.
...
## LOOP CONNECTION
Decay opens refresh initiatives.
