# Screen contract: loop_monitor

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Determine whether changes actually worked.

## USER QUESTIONS
What was the baseline, what is the signal, what is the verdict?

## USER DECISIONS
Whether to scale, revise or roll back.
