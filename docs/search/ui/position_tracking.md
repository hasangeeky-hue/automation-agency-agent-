# Screen contract: position_tracking

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Detect ranking changes daily.

## USER QUESTIONS
What improved, declined, or was lost?

## USER DECISIONS
Which decline to investigate.
...
## LOOP CONNECTION
The primary trigger for the ranking detector.
