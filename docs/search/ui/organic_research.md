# Screen contract: organic_research

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
What a domain ranks for and how that is trending.

## USER QUESTIONS
Which keywords drive traffic? What moved?

## USER DECISIONS
Which keywords to track or target.
...
## LOOP CONNECTION
Ranking losses open initiatives via detect_ranking_drops.
