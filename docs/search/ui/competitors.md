# Screen contract: competitors

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Who competes for our search demand.

## USER QUESTIONS
Who overlaps with us and where are they stronger?

## USER DECISIONS
Which competitor to study.
...
## LOOP CONNECTION
Competitor movement is evidence on ranking initiatives.
