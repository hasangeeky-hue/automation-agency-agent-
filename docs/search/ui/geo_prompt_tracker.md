# Screen contract: geo_prompt_tracker

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Track prompts over time and providers.

## USER QUESTIONS
Which prompts mention us, and did that change?

## USER DECISIONS
Which prompt to work on.
...
## LOOP CONNECTION
Prompt loss opens an initiative; re-run closes it.
