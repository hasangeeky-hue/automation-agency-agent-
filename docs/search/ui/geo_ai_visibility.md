# Screen contract: geo_ai_visibility

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
How visible the brand is inside AI answers.

## USER QUESTIONS
Are we mentioned and cited, and by whom?

## USER DECISIONS
Which visibility gap to close.
...
## LOOP CONNECTION
Gaps open content or entity initiatives.
