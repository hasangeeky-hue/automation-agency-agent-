# Screen contract: site_audit_overview

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Technical health, with its components.

## USER QUESTIONS
How healthy is the site and what category is worst?

## USER DECISIONS
Which issue category to attack.
...
## LOOP CONNECTION
Issues become technical initiatives.
