# Screen contract: keyword_gap

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Find search demand competitors own and we do not.

## USER QUESTIONS
What do they rank for that we miss?

## USER DECISIONS
Create content, optimise an existing page, or dismiss.
...
## LOOP CONNECTION
Each accepted gap opens a content initiative.
