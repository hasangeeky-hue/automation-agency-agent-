# Screen contract: command_center

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Answer: how is search performing, what changed, what is broken, and what should we do next.

## USER QUESTIONS
Is search growing? What broke? Where are competitors winning? How visible are we in AI search?

## USER DECISIONS
Which opportunity to open next.
...
## LOOP CONNECTION
Opens initiatives from the What Should We Do Next list.
