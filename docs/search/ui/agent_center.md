# Screen contract: agent_center

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
What the agents are doing and what it costs.

## USER QUESTIONS
Which agent is running, on what, within what budget?

## USER DECISIONS
Whether to stop or escalate a run.
...
## LOOP CONNECTION
Shows bounded runs and escalations.
