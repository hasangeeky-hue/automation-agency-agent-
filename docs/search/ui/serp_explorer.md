# Screen contract: serp_explorer

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
What the result page actually looks like for a query.

## USER QUESTIONS
Which features occupy the SERP? Who holds them?

## USER DECISIONS
Whether the SERP is winnable.
...
## LOOP CONNECTION
SERP change is a diagnosis input for ranking loss.
