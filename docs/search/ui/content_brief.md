# Screen contract: content_brief

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Turn a topic into a writable brief.

## USER QUESTIONS
What must this piece cover to win?

## USER DECISIONS
Approve the brief or revise it.
...
## LOOP CONNECTION
An approved brief becomes a draft initiative.
