# Screen contract: aeo_questions

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Questions people ask that we should answer.

## USER QUESTIONS
What is asked, and do we answer it?

## USER DECISIONS
Which answer to improve.
...
## LOOP CONNECTION
Missing answers open content initiatives.
