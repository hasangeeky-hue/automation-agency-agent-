# Screen contract: citation_gap

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Sources that cite competitors and not us.

## USER QUESTIONS
Where do AI answers get their evidence?

## USER DECISIONS
Which source to pursue.
...
## LOOP CONNECTION
Opens evidence and authority initiatives.
