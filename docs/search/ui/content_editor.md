# Screen contract: content_editor

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Write and optimise against the brief.

## USER QUESTIONS
Does this draft cover the intent, questions and entities?

## USER DECISIONS
Publish, or keep editing.
...
## LOOP CONNECTION
Publishing moves the initiative to EXECUTING.
