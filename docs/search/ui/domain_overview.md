# Screen contract: domain_overview

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
One domain's search position at a glance.

## USER QUESTIONS
How visible is this domain? What does it rank for? Who competes?

## USER DECISIONS
Whether this domain is worth researching further.
...
## LOOP CONNECTION
Feeds competitor and keyword opportunities.
