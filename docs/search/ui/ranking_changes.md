# Screen contract: ranking_changes

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Separate new, improved, declined and lost.

## USER QUESTIONS
What moved and how much traffic is at risk?

## USER DECISIONS
Which change to open work for.
...
## LOOP CONNECTION
Declines feed initiatives with a baseline.
