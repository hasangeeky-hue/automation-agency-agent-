# Screen contract: execution_board

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Control every change in flight.

## USER QUESTIONS
What is proposed, approved, executing, executed, verified?

## USER DECISIONS
What to approve or roll back.
