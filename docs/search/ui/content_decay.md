# Screen contract: content_decay

Generated from content_engine_search_tokens.CONTRACT_FIELDS.
Spec section 96: no screen may be implemented without this.

## PURPOSE
Pages losing search performance over time.

## USER QUESTIONS
What is declining and since when?

## USER DECISIONS
Which page to refresh first.
...
## LOOP CONNECTION
Decay is a detector that opens initiatives.
