...
def build_outreach_ctx(store, *, jobs=None, reply_drafts=None, bookings=None,
    ...
    return {
        ...
        # seven screens open on the founder's real leads, campaigns, sends,
        # opens and clicks rather than on an empty new store. The keys that
        # used to sit beside it (campaigns, profiles, segments, flows,
        # preview) fed boards that no longer exist and were removed with
        # them rather than left to rot.
